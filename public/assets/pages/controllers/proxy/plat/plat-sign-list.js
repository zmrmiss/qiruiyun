 ...
 *
 */
angular.module('App').controller('MassPlatSignCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModal) {

    $scope.currentTab = 'mass.sign';

    console.log(sessionStorage.getItem("massApikey"))
    ...
    $scope.open = function(data) {
        $uibModal.open({
            ...
            controller: 'MessagePlatSignEditCtrl',
            size: 'md',
            resolve:{
                data : function(){
                    return {
...
angular.module('App').controller('MessagePlatSignEditCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModalInstance, data) {
