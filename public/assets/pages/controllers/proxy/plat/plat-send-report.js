 ...
 *
 */
angular.module('App').controller('MassPlatSendReportCtrl', function($rootScope, $stateParams, $scope, $ajax ,$filter) {

    $scope.currentTab = 'mass.sendReport';
