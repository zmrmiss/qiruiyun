 ...
 *
 */
angular.module('App').controller('MouldIndustrydReplyYesterdayCtrl', function($rootScope, $stateParams, $scope, $ajax,$uibModal) {

    $scope.currentTab = 'mould.reply.today';
    $scope.currentTab2 = 'mould.reply.yesterday';
