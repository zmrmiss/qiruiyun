 ...
 *
 */
angular.module('App').controller('MouldIndustrydReplyEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax,$uibModal ,$filter,$state) {

    $scope.currentTab = 'mould.reply.today';
    $scope.currentTab2 = 'mould.reply.earlier';
