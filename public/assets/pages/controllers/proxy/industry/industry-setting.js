 ...
 *
 */
angular.module('App').controller('IndustrySetupCtrl', function($rootScope, $stateParams,$scope, $ajax,$uibModal) {
    $scope.currentTab = 'industry.setting';
    ...
    $scope.load = function() {
        ...
        var data={username:apindustry,page:$scope.paginationConf.currentPage,limit: 10, telephone:$scope.params.telephone};
    ...
    $scope.open = function() {
        $uibModal.open({
            ...
            controller: 'MessageIndustryBlackAppendCtrl',
            size: 'md',
            resolve:{
                data : function(){
                    return {
                        item: angular.copy(apindustry),
                        callback: function() {
                            $scope.load();
                        }
                    }
        ...
        layer.msg('你确定删除该黑名单吗？', {
            ...
            yes: function(index){
                ...
                $ajax.post('/api/marketing/Blacklist/remove', $.param({
                    id: data.id,username:apindustry
                }), function () {
...
//黑名单
angular.module('App').controller('MessageIndustryBlackAppendCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModalInstance, data) {
