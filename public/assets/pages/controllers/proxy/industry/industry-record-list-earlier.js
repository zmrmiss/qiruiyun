 ...
 *
 */
angular.module('App').controller('MouldIndustryRecordEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax , $filter, $state) {

    $scope.currentTab = 'mould.record.today';
    $scope.currentTab2 = 'mould.record.earlier';
