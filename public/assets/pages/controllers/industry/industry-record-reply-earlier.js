 ...
 *
 */
angular.module('App').controller('MessageIndustrydReplyEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax,$uibModal ,$filter,$state) {

    $scope.currentTab = 'industry.reply.today';
    $scope.currentTab2 = 'industry.reply.earlier';
