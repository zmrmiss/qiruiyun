 ...
 *
 */
angular.module('App').controller('MessageIndustryRecordEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax , $filter, $state) {

    $scope.currentTab = 'industry.record.today';
    $scope.currentTab2 = 'industry.record.earlier';
