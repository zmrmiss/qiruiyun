 ...
 *
 */
angular.module('App').controller('MessagePlatdReplyEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax,$uibModal ,$state) {

    $scope.currentTab = 'plat.reply.today';
    $scope.currentTab2 = 'plat.reply.earlier';
