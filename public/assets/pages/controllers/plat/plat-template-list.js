 ...
 *
 */
angular.module('App').controller('MessagePlatTemplateCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModal) {

    $scope.currentTab = 'plat.template';

    $rootScope.statusData2 = [{name:"不限",status:""},
        {name:"待审核",status:0},
        {name:"审核通过",status:1},
        {name:"审核驳回",status:2},
        {name:"已移除",status:3}
    ...
    $scope.open4 = function(data) {
        $uibModal.open({
            backdrop: 'static',
            templateUrl: 'signTemplate.html',
            controller: 'MessagePlatTemplateEditCtrls',
            size: 'md',
            resolve:{
                data : function(){
                    return {
    ...
    $scope.openMatch = function(template) {
        $uibModal.open({
            ...
            controller: 'PlatTemplateMatchCtrl',
            size: 'md',
            resolve:{
                data : function(){
                    return {
    ...
    $scope.delete = function (id) {
        layer.msg('你确定删除该模板吗？', {
            ...
            yes: function(index){
                layer.close(index);
                $ajax.post('/api/marketing/Template/remove', $.param({id: id , username:apikey}), function () {
...
angular.module('App').controller('MessagePlatTemplateEditCtrls', function($rootScope, $stateParams, $scope, $ajax, $uibModalInstance, data) {
...
angular.module('App').controller('PlatTemplateMatchCtrl', function($rootScope, $stateParams, $scope, $ajax, $uibModalInstance, data) {
