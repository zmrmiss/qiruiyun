 ...
 *
 */
angular.module('App').controller('MessagePlatRecordEarlierCtrl', function($rootScope, $stateParams, $scope, $ajax , $filter ,$state) {

    $scope.currentTab = 'plat.record.today';
    $scope.currentTab2 = 'plat.record.earlier';
